...
**2.1** Put on nitrile gloves to not contaminate your samples with your own DNA. Try to as few things as possible with those gloves.

**2.2** Everyone will get **aluminium foil**, a sterile **scalpel blade**, and a small **PCR reaction tube** (max. volume capacity of 200 µL) which has the previously assigned sample number on it.
...
**2.5** Place the tissue on the folded foil and cut it into a small piece that fits inside the small PCR reaction tube that was not in touch with 
